...
class EnhancedGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     * Fire the failed authentication attempt event with the given arguments.
     *
     * TODO: Create Event and Listener in \App
     *
     * @param  \Illuminate\Contracts\Auth\Authenticatable|null  $user
     * @param  array  $credentials
     * @return void
    ...
    public function validateActivation(AuthenticatableContract $user = null)
    {
